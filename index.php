...
<body>
        ...
        <div class="container pt-md-0 pt-5 pb-0" >
            <div class="row ">
                <div class="col-md-6 col-sm-12 align-self-center mb-md-0 mb-4 ">
                    ...
                    <a href="#" class="btn btn-primary rounded-pill entrar border-0 d-md-inline-block d-flex flex-sm-column btn_land mb-md-0 mb-2 me-md-2" id="btn_cad">Cadastre-se</a>
                    <a href="#" class="btn btn-primary rounded-pill entrar border-0 d-md-inline-block d-flex flex-sm-column btn_land" id="btn_cad">Entrar</a>
                </div>
                <div class="col-md-6 col-sm-12 text-center" id="img_principal">
                    <img src="assets/Img Home Principal.svg"  alt="" srcset="" class="img_fluid">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container pt-md-0 pt-5 pb-5" id="cont_sobre">
            <div class="row">
                <div class="col-md-6 col-sm-12 text-center mb-md-0 mb-4 order-md-1 order-2">
                    <img src="assets/teste certificado.svg" alt="" srcset="" class="img_fluid" id="img_sobre">
                </div>
                ...
                <div class="col-md-6  mb-4 cards ">
                    <a href="#" class="destaque">
                        <div clss="img-container mb-3 ">
                            <img src="assets/Certificado Digital Img1.svg" alt="" srcset="" class="img_fluid">
                        </div>
                ...
                <div class="col-md-6 mb-4 cards">
                    <a href="#"  class="destaque">
                        <div clss="img-container mb-3 destaque" >
                            <img src="assets/Assinatura Digital Img.svg" alt="" srcset="" class="img_fluid" id="assina">
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 col-sm-12 me-5 card_vant">
                    <div clss="img-container" >
                        <img src="assets/Dinheiro.svg" alt="" srcset="" class="img_fluid" class="icon_vant">
                        <h5>Sem Custo</h5>
                ...
                <div class="col-md-4 col-sm-12 me-5 card_vant d-flex align-items-end" id="baixo">
                    <div clss="img-container" >
                        <img src="assets/Lampada.svg" alt="" srcset="" class="img_fluid" class="icon_vant">
                        <h5>Sustentável</h5>
                ...
                <div class="col-md-4 col-sm-12 card_vant">
                    <div class="img-container" >
                        <img src="assets/Pessoas.svg" alt="" srcset="" class="img_fluid" class="icon_vant">
                        <h5>Inclusivo</h5>
    ...
    <footer class="container footer mt-0">
        ...
        <div class="d-flex justify-content-center sociais">
                <img src="assets/Intagram.png" class="social " id="Insta" alt="" srcset="">
                <img src="assets/Facebook.png" class="social" id="Face" alt="" srcset="">
                <img src="assets/Youtube.png" class="social" id="You" alt="" srcset="">
                <img src="assets/Linkedin.png" class="social" id="Link" alt="" srcset="">
                <img src="assets/Github.png" class="social" id="Git" alt="" srcset="">
        </div>
        <div class="d-flex justify-content-center align-items-center mt-3 mb-3" id="copyright">
            <img src="assets/Copyright.png" alt="" srcset="" class="me-2">
